<template>
  <div class="col-12 col-md-5 col-xxl-4 d-flex order-2 order-xxl-2">
    <div class="card flex-fill w-100 mh-100">
              ...
              <div class="col-12 col-md-4 col-xxl-3 text-end">
                <div class="grid input-group input-group-sm">
                  ...
                  <span class="input-group-btn">
                    <button type="button" class="btn btn-outline-primary btn-sm ms-1">+</button>
                  </span>
                </div>
              </div>
              <div class="col-12 col-md-3 col-xxl-3 text-end">
                <strong class="card-text">$ 200.00</strong>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="card-footer">
        ...
        <div class="row py-1">
          <div class="col-12 col-md-12">
            ...
            <div class="row gx-1">
              ...
              <div class="col">
                <div class="d-grid gap-2 p-1">
                  <button class="btn btn-primary btn-sm">50</button>
                </div>
              </div>
              <div class="col">
                <div class="d-grid gap-2 p-1">
                  <button class="btn btn-primary btn-sm">100</button>
                </div>
              </div>
              <div class="col">
                <div class="d-grid gap-2 p-1">
                  <button class="btn btn-primary btn-sm">500</button>
                </div>
              </div>
              <div class="col">
                <div class="d-grid gap-2 p-1">
                  <button class="btn btn-primary btn-sm">1,000</button>
                </div>
              </div>
            </div>
            <!-- </div> -->
        ...
        <div class="row py-1">
          ...
          <div class="col-12 col-md-3 text-end">
            <span class="h5" style="font-weight: 500"> 0.00 </span>
            <!-- <p class="card-text">$ 200.00</p> -->
          </div>
        </div>
        <div class="row py-1">
